...
case ${CIRCLE_NODE_INDEX} in
  ...
  1)
    ...
    fmriprep-docker -i poldracklab/fmriprep:latest --config $HOME/nipype.cfg -w $HOME/ds005/scratch $HOME/data/ds005 $HOME/ds005/out participant --template --debug --write-graph --use_aroma
