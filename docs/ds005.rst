...
The t1w_preprocessing sub-workflow finds the skull stripping mask and the white matter/gray matter/cerebrospinal fluid segments.

.. figure:: _static/brainextraction.svg
    :scale: 100%

    Brain extraction (by BET). Hover to pause.
...
The EPI_HMC sub-workflow collects BIDS_-formatted EPI files and performs head motion correction.

EPIMeanNormalization
~~~~~~~~~~~~~~~~~~~~

.. image:: EPIMeanNormalization.dot.png
    :scale: 100%
...
.. figure:: _static/EPIT1Normalization.svg
    ...
    Animation showing EPI to T1 registration. Hover to pause.

.. figure:: _static/T1MNINormalization.svg
    :scale: 100%

    Animation showing T1 to MNI normalization. Hover to pause.
...
Calculated confounds include the mean global signal, mean tissue class signal, tCompCor, aCompCor, and DVARS.
